...
<body class="flex">
        ...
        <div id="top-sidebar">
            ...
            <nav id="sidebar-menu" class="mt-3">
                <ul>
                    ...
                    <li class="">
                        <button id="event-management-toggle" class="{{ Route::is(['society.event_application_view', 'society.create-event-view', 'society.successReportView'])? 'text-purple-300 font-semibold':'' }} cursor-pointer flex items-center gap-4 hover:bg-slate-300 hover:text-purple-900 p-3 rounded-md w-full">
                            <span class="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            ...
                            <span>
                                <svg id="sidebar-dropdown-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3 ml-auto">
                        ...
                        <ul id="event-management-submenu" class="mt-2 hidden">
                            <li class="{{ Route::is('society.event_application_view') ? 'border-purple-600 font-semibold' : '' }} ml-12 p-2 border-l-2 border-purple-300 hover:border-purple-600 hover:font-semibold">
                                <a href="{{ route("society.event_application_view") }}" class="cursor-pointer">
                                    <span class="text-sm">Application</span>
                                </a>
                            </li>
                            <li class="{{ Route::is('society.successReportView') ? 'border-purple-600 font-semibold' : '' }} ml-12 p-2 cursor-pointer border-l-2 border-purple-300 hover:border-purple-600 hover:font-semibold">
                                <a href="{{ route('society.successReportView') }}" class="cursor-pointer">
                                    <span class="text-sm">Success Report</span>
                                </a>
                            </li>
                            <li class="{{ Route::is('society.create-event-view') ? 'border-purple-600 font-semibold' : '' }} ml-12 p-2 cursor-pointer border-l-2 border-purple-300 hover:border-purple-600 hover:font-semibold">
                                <a href="{{ route('society.create-event-view') }}" class="cursor-pointer">
                    ...
                    <li class="{{ Route::is('society.add_society_advisor_view')? 'active' : '' }} rounded-md p-3 hover:bg-slate-300 hover:text-purple-900 cursor-pointer ">
                        ...
                        <span class="menu-text text-sm">Add Society Advisor</span>
                        </a>
                    </li>
                    @endif
    ...
    <!-- Main Content -->  
    <main id="main-section" class="flex flex-col p-6 w-full ml-64 h-screen">
