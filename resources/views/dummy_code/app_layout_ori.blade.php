            ...
            <ul>
                ...
                <li class="">
                    ...
                    <ul id="event-management-submenu" class="mt-2 hidden">
                        <li class="{{ Route::is('event_management.application') ? 'border-purple-600 font-semibold' : '' }} ml-12 p-2 border-l-2 border-purple-300 hover:border-purple-600 hover:font-semibold">
