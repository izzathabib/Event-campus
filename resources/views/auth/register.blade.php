    ...
    <form method="POST" action="{{ route('register') }}" class="mt-9">
        ...
        <div>
            ...
            <div class="flex justify-between mt-2">
                <div class="border-gray-300 flex place-items-center gap-2 p-2 text-xs font-semibold text-gray-900 border rounded-md hover:bg-black hover:text-white cursor-pointer" id="acc-type" data-value="society">
                ...
                <div class="border-gray-300 flex place-items-center gap-2 p-2 text-xs font-semibold text-gray-900 border rounded-md hover:bg-black hover:text-white cursor-pointer" id="individual" onclick="document.getElementById('account_type_input').value = 'individual'">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                    </svg>
                    <span class="truncate">Individual</span>
                </div>
                <div class="border-gray-300 flex place-items-center gap-2 p-2 text-xs font-semibold text-gray-900 border rounded-md hover:bg-black hover:text-white cursor-pointer" id="admin" onclick="document.getElementById('account_type_input').value = 'admin'">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
