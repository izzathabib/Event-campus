...
<body class="flex">
    <!-- Sidebar -->
    <aside id="sidebar" class="sidebar h-screen w-64 transition-all p-2">
        ...
        <nav class="mt-3">
            <ul>
                <li class="{{ Route::is('dashboard')? 'active' : '' }} rounded-md p-3 hover:bg-slate-300 cursor-pointer">
                ...
                <li class="">
                    <button class="{{ Route::is(['event_management.application'])? 'text-purple-600 font-semibold':'' }} cursor-pointer flex items-center gap-4 hover:bg-slate-300 p-3 rounded-md" id="event-management-toggle">
                        <span class="">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    ...
                    <ul id="event-management-submenu" class="mt-2 hidden">
                        <li class="{{ Route::is('event_management.application') ? 'border-purple-600 font-semibold' : '' }} ml-9 p-2 border-l-4 border-purple-300 hover:border-purple-600 hover:font-semibold">
                            <a href="{{ route('event_management.application') }}" class="cursor-pointer">
                                <span class="text-sm">Application</span>
                            </a>
                        </li>
                        <li class="ml-9 p-2 cursor-pointer border-l-4 border-purple-300 hover:border-purple-600 hover:font-semibold">
                            <a href="#" class="">
    ...
    <main class="flex-1 p-6">
        <div class="flex flex-wrap gap-7 mb-4 justify-end">
            <!-- Notification Icon -->
            <div class="flex">
            ...
            <div class="flex items-center">
                <div class="mr-3">
                    <p class="font-semibold text-sm">Persada USM</p>
                </div>
                <div class="relative">
    ...
    <!-- Bottom navigation for phone user -->
