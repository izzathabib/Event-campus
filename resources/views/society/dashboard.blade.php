...
<div class="bg-white rounded-lg border border-gray-300 overflow-hidden mt-6 w-1/5">
 ...
 <div class="bg-white rounded-lg border border-gray-300 overflow-hidden mt-14">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td class="px-4 py-2 border-b text-sm flex gap-2 item-center justify-center">
                ...
                <!-- Edit Icon -->
                <div>
                  <form action="{{ route('society.editEventApplicationForm', $event->id) }}" method="GET">
                    <button title="Edit event applications" type="submit">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-5 text-gray-600 hover:text-gray-800">
  ...
  <!-- Advisor List -->
  <div class="bg-white rounded-lg border border-gray-300 overflow-hidden mt-4 w-2/5">
