        ...
        <div id="top-sidebar">
            ...
            <nav id="sidebar-menu" class="mt-3">
                <ul>
                    ...
                    <li class="">
                        <button class="{{ Route::is(['society.event_application_view'])? 'text-purple-600 font-semibold':'' }} cursor-pointer flex items-center gap-4 hover:bg-slate-300 p-3 rounded-md w-full" id="event-management-toggle">
                            <span class="">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
